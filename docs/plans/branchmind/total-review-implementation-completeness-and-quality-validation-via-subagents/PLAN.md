[LEGEND]
planfs_v1:
  plan_slug: total-review-implementation-completeness-and-quality-validation-via-subagents
  title: 'Total review: implementation completeness and quality validation via subagents'
  objective: Deliver task PlanFS driver for PLAN-004 with deterministic slice-by-slice execution.
  constraints:
...
[CONTENT]
## Goal
Deliver task PlanFS driver for PLAN-004 with deterministic slice-by-slice execution.
## Scope
...
## Proof
- CMD: tasks.planfs.export --task TASK-033
## Rollback
